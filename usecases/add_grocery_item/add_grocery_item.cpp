...
AddGroceryItem::AddGroceryItem(entities::GroceryItems *groceryItems , QObject *parent)
    : QObject(parent), m_groceryItems(groceryItems)
{
    connect(m_groceryItems,
            &entities::GroceryItems::created,
            this,
            &AddGroceryItem::onGroceryItemCreated);
    connect(m_groceryItems,
            &entities::GroceryItems::notCreated,
            this,
            &AddGroceryItem::onGroceryItemNotCreated);
}
...
{
    emit success("ADD_GROCERY_ITEM__FAILURE");
}
