...
RemoveGroceryItem::RemoveGroceryItem(entities::GroceryItems *groceryItems, QObject *parent)
    : QObject(parent),
      m_groceryItems(groceryItems)
{
    connect(m_groceryItems, &entities::GroceryItems::removed,
            this, &RemoveGroceryItem::onGroceryItemRemoved);
    connect(m_groceryItems ,&entities::GroceryItems::notRemoved,
            this, &RemoveGroceryItem::onGroceryItemNotRemoved);
}
